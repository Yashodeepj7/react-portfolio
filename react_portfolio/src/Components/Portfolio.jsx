                ...
                <Col md={4} key={index} className="mb-4 d-flex hover-shadow hover-zoom">
                  <Card className="text-white bg-dark border border-secondary w-100 shadow-lg" style={{ minHeight: "400px" }}>
                    ...
                    <Card.Body className="d-flex flex-column justify-content-between hover-shadow hover-zoom">
                      ...
                      <div>
                       <Button style={{ backgroundColor: "#6b46c1", border: "none" }} className="me-2"> <a style={{ color: 'white' }} className=" text-decoration-none" href={project.githubLink || "Github Link is not available"} target="_blank"  >
                          GitHub
                        </a></Button>
                       <Button style={{ backgroundColor: "#a855f7", border: "none" }}> <a style={{ color: 'white' }} className=" text-decoration-none" href={project.demoLink || "Demo Link not available"} target="_blank" >
                          Demo
                        </a></Button> 
                      </div>
                    </Card.Body>
